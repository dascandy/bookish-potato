...
/*
void interrupt_set_vector(uint8_t vector, interrupt_handler function) {
  interrupt_set_vector(vector, function, IST::Interrupt);
}
*/
static void interrupt_set_vector(uint8_t vector, interrupt_handler function, IST ist) {
  ...
  for (size_t n = 0; n < 256; n++) {
    switch(n) {
      ...
      case 30:
        ...
        break;
      default:
        interrupt_set_vector(n, unhandled_interrupt_noec, n < 32 ? IST::Unhandled : IST::Interrupt);
        break;
    }
  }
